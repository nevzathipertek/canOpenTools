...
//--------------------------------------------------------------------//
FDCAN_HandleTypeDef* CANBUS::pCanUsed;
...
void CANBUS::init(uint8_t _nodeID_, uint8_t _baudKHz_){
	...
	canOpen.baudrate = _baudKHz_; //250'000;
...
//--------------------------------------------------------------------//
//--------------------------------------------------------------------//
void CANBUS::sendRequest0(void){	CO_TPDOsendRequest(&canOpen.canOpenStack->TPDO[0]);	}
//--------------------------------------------------------------------//
void CANBUS::sendRequest1(void){	CO_TPDOsendRequest(&canOpen.canOpenStack->TPDO[1]);	}
//--------------------------------------------------------------------//
void CANBUS::sendRequest2(void){	CO_TPDOsendRequest(&canOpen.canOpenStack->TPDO[2]);	}
//--------------------------------------------------------------------//
void CANBUS::sendRequest3(void){	CO_TPDOsendRequest(&canOpen.canOpenStack->TPDO[3]);	}
//--------------------------------------------------------------------//
//--------------------------------------------------------------------//
//--------------------------------------------------------------------//
//--------------------------------------------------------------------//
